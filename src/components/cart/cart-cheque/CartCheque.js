    ...
    return (
        <div className="cart__check">
            ...
            <div className="cart__check-wrapper">
                <div className="cart__check-left">
                    Промежуточный итог
                </div>
                <div className="cart__check-right">
            ...
            <div className="cart__check-wrapper cart__check-wrapper-sum">
                <div className="cart__check-sum">Итог</div>
                <div className="cart__check-pay">{price.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") + " ₽"}</div>
            </div>


            <div className="cart__check-wrapper cart__check-wrapper-pay">
                <div className="cart__check-lock">
