...
const StatusDetails = ({orderDetails}) => {
    ...
    return (
        <div className="status__details">
            <div className="status__details-left">

                <div className="status__details-info">
            ...
            <div className="status__details-right">
                ...
                <div className="status__details-info">
                    ...
                    <div className="status__pay">
                        <div className="status__pay-info">
                            <div className="status__pay-left">Товары</div>
                            <div className="status__pay-right">{total} ₽</div>
                        </div>
                        <div className="status__pay-info">
                            <div className="status__pay-left">Доставка</div>
                            <div className="status__pay-right">{deliveryPrice} ₽</div>
                        </div>
                        <div className="status__pay-info">
                            <div className="status__pay-left">Скидка</div>
                            <div className="status__pay-right">{orderDetails[0].sale ? sale + '₽' : 0}</div>
                        </div>
                        <div className="status__pay-info" style={{marginTop: '30px'}}>
                            <div className="status__pay-left" style={{fontWeight: 700}}>Итого</div>
                            <div className="status__pay-right">{total + deliveryPrice - sale} ₽</div>
                        </div>
                    </div>
                </div>
