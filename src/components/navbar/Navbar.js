            ...
            <div className="side__inner">
                ...
                <nav className="nav">
                    <ul className="nav__list">
                        ...
                        {isAuth ?
                            <NavItems pathway={"/cart"} name={"Корзина"}>
                                <svg className="nav__list-link-icon" width="25" height="25" viewBox="0 0 25 25"
                                     fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                ...
                <div className="side__footer">
                    {isAuth
                        ...
                        ? <button className="logout-link" onClick={() => handleLogout()} title="Logout">
                            ...
                            <span className="logout-link__text">Выйти</span>
                        </button>

                        : <button className="logout-link" title="Login" onClick={() => setModal(true)}>
                            ...
                            <span className="logout-link__text">Войти</span>
                        </button>
                    }
